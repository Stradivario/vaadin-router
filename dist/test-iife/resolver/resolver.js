...
this.VaadinTestNamespace.Resolver = (function (pathToRegexp, matchRoute) {
  'use strict';

  pathToRegexp = pathToRegexp && Object.prototype.hasOwnProperty.call(pathToRegexp, 'default') ? pathToRegexp['default'] : pathToRegexp;
  matchRoute = matchRoute && Object.prototype.hasOwnProperty.call(matchRoute, 'default') ? matchRoute['default'] : matchRoute;
...
}(VaadinTestNamespace.pathToRegexp, VaadinTestNamespace.matchRoute));
